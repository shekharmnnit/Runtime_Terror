...
function Post() {
    ...
    return (
        <div>Hello from Post
            <div className='w-50'>
                <textarea className='w-100' value={caption} onChange={(e) => setCaption(e.target.value)} placeholder='Enter Caption' type='textarea' style={{ backgroundColor: '#D9D9D9' }} />
                ...
                <MDBInput wrapperClass='mb-4' value={caption} onChange={(e) => setCaption(e.target.value)} placeholder='Enter Caption' type='file' style={{ backgroundColor: '#D9D9D9' }} />
